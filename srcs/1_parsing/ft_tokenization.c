...
/*   Updated: 2024/02/27 23:58:06 by janhan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_operator_process(t_parse *parse)
{
	...
	else if (ft_is_redirect(parse->line[parse->line_index]))
	{
...
static void	ft_qoute_process(t_parse *parse)
{
	char	end_quote;
